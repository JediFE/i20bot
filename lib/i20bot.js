...
I20bot.prototype._onStart = function () {
    ...
    this._replyToChanel(channel, "Hello everybody, I'm I20bot. I can help you send a star, just send a message in next format:  '@user: [cristal count] :star: [description (because he is cool!!!)]'");
};
...
I20bot.prototype._parseMessage = function (message) {
    ...
    if (messageArr) {
        ...
        self._replyToChanel(channel, gcs);
    }
    else {
        self._replyToChanel(channel, "I don't understand you, please use next format: '@user: [cristal count] :star: [description (because he is cool!!!)]'");
    }
};
